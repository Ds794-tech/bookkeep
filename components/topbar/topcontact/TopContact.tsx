...
export default function TopBar() {
    return (
        <div className="max-w-7xl mx-auto md:relative bg-white p-3 border-b border-gray-100">
            <div className="md:flex md:items-center md:justify-between py-3 text-sm">

                {/* Left Section - Phone & Text */}
                <div className="md:fixed md:bg-fixed md:top-0 md:shadow-md md:right-0 md:left-0 md:z-20 px-0 md:px-5 py-1 bg-white md:flex md:justify-between md:items-center">
                    ...
                    <div className="flex mt-5 items-center justify-center space-x-4 text-teal-600">
